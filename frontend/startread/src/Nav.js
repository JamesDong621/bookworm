    ...
    <div>
      <nav class="navbar">
        <div class="navbar-left">
            ...
            <button class="nav-link" onClick={() => window.location.href = 'http://localhost:3003/'}>
                Quick Reading
            </button>
            <button class="nav-link" onClick={() => window.location.href = 'http://localhost:3000/'}>
                Start Reading
            </button>
            <button class="nav-link" onClick={() => window.location.href = 'http://localhost:3001/'}>
                Book Log
            </button>
        </div>
        <div class="navbar-right">
            ...
            <button  class="home-btn" id="logout" onClick={() => window.location.href = 'http://127.0.0.1:5000/login'}>Logout</button>
